...
<html>
    ...
    <center>
        <br/>
        <h2 style="color: crimson"><u><b>CURRENT BOOKING DETAILS</b></u></h2>
        ...
        <table class="w3-table-all">
            ...
            <%
                ...
                ResultSet rs = pkgbean.Booking.showRecords();
            ...
            <tr>
                ...
                <td><a href="http://localhost:7070/HotelManagementSystem/booking_management/checkout/checkoutprocess.jsp?booking_id=<%=booking_id%>" target="frame_right" style="color: blue">Checkout</a></td>
            </tr>
